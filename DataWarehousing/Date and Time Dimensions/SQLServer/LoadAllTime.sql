CREATE PROCEDURE [Dims].[LoadAllTime]
AS
BEGIN
	;WITH
		[Hour]
	...
	(
		...
		[HourNumber], [HalfHourNumber], [QuarterHourNumber], [MinuteNumber], [SecondNumber], [TimeOfDayNumber], [SubTimeOfDayNumber], 
		...
		SELECT
			...
			[TimeLabels].[HourNumber], [TimeLabels].[HalfHourNumber], [TimeLabels].[QuarterHourNumber], [TimeLabels].[MinuteNumber], [TimeLabels].[SecondNumber], [TimeLabels].[TimeOfDayNumber], [TimeLabels].[SubTimeOfDayNumber], 
